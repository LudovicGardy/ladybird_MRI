...
class Main_Win(QMainWindow):
    ...
    def display_window(self, file_type):
        ...
        if "nifti" in file_type and "template" not in file_type.lower():
            fpath = QFileDialog.getOpenFileName(
                None, "Select a NIfTI file:", fpath, "NIfTI files (*.nii *nii.gz)"
            )[0]
        elif "dicom" in file_type and "template" not in file_type.lower():
            fpath = QFileDialog.getExistingDirectory(
                None, "Select a DICOM folder:", fpath, QFileDialog.ShowDirsOnly
            )
    ...
    def set_menu(self):
        ...
        self.load_sub_menu.addAction(
            "&From NIfTI", lambda: self.display_window("nifti")
        )
        self.load_sub_menu.addAction(
            "&From DICOM", lambda: self.display_window("dicom")
        )
        ...
        self.atlas.addAction(
            "&AICHAmc", lambda: self.display_window("nifti-template-AICHAmc")
        )
        self.atlas.addAction(
            "&Brodmann", lambda: self.display_window("nifti-template-brodmann")
        )
        self.atlas.addAction("&Ch2", lambda: self.display_window("nifti-template-ch2"))
        self.atlas.addAction(
            "&Ch2bet", lambda: self.display_window("nifti-template-ch2bet")
        )
        self.atlas.addAction(
            "&Ch2better", lambda: self.display_window("nifti-template-ch2better")
        )
        self.atlas.addAction(
            "&HarvardOxford",
            lambda: self.display_window(
                "nifti-template-HarvardOxford_cort_maxprob_thr0_1mm"
            ),
        )
        self.atlas.addAction(
            "&Inia19-NeuroMaps",
            lambda: self.display_window("nifti-template-inia19_NeuroMaps"),
        )
        self.atlas.addAction(
            "&Inia19-T1", lambda: self.display_window("nifti-template-inia19_t1_brain")
        )
        self.atlas.addAction(
            "&JHU-WhiterMatter-1mm",
            lambda: self.display_window("nifti-template-JHU_WhiteMatter_labels_1mm"),
        )
        self.atlas.addAction(
            "&JHU-WhiterMatter-2mm",
            lambda: self.display_window("nifti-template-JHU_WhiteMatter_labels_2mm"),
        )
        self.atlas.addAction(
            "&Natbrainlab", lambda: self.display_window("nifti-template-natbrainlab")
        )
    ...
    def set_toolbar(self):
        ...
        ##### Set buttons #####
        ### New button
        rotateLeft_button = QAction(
            QtGui.QIcon(
                os.path.join(get_path()["toolbar_icones"], "icons8-rotate-left-96.png")
            ),
            "Rotate left",
            self,
        )
        ...
        ### New button
        rotateRight_button = QAction(
            QtGui.QIcon(
                os.path.join(get_path()["toolbar_icones"], "icons8-rotate-right-96.png")
            ),
            "Rotate right",
            self,
        )
        ...
        ### New button
        expandVew_button = QAction(
            QtGui.QIcon(
                os.path.join(get_path()["toolbar_icones"], "icons8-expand-96.png")
            ),
            "Expand view",
            self,
        )
        ...
        button1 = QAction(
            QtGui.QIcon(
                os.path.join(
                    get_path()["toolbar_icones"], "icons8-restore-window-64.png"
                )
            ),
            "Restore original",
            self,
        ...
        button2 = QAction(
            QtGui.QIcon(
                os.path.join(get_path()["toolbar_icones"], "icons8-statistics-64.png")
            ),
            "Sobel filter",
            self,
        )
        ...
        button3 = QAction(
            QtGui.QIcon(
                os.path.join(
                    get_path()["toolbar_icones"],
                    "icons8-illumination-brightness-96.png",
                )
            ),
            "Brightness",
            self,
    ...
    def call_centWidget_expandView_fun(self):
        try:
            ...
            var = traceback.format_exc()
            user_answer = messageBox_popup(
                "Error", var, QMessageBox.Icon.Critical, cancel_option=False
            )

    def init_plot(self):
        try:
            self.centWidget.img_view1 = plot_volume(
                self.centWidget.figure1_canvas,
                self.centWidget.volume,
                "View_1",
                self.centWidget.view1_Slider.value(),
                kernel=self.centWidget.kernel,
                file_type=self.file_type,
                atlas_name=self.atlas_name,
                rotation=self.centWidget.rotation_view1,
            )
            self.centWidget.img_view2 = plot_volume(
                self.centWidget.figure2_canvas,
                self.centWidget.volume,
                "View_2",
                self.centWidget.view2_Slider.value(),
                kernel=self.centWidget.kernel,
                file_type=self.file_type,
                atlas_name=self.atlas_name,
                rotation=self.centWidget.rotation_view2,
            )
            self.centWidget.img_view3 = plot_volume(
                self.centWidget.figure3_canvas,
                self.centWidget.volume,
                "View_3",
                self.centWidget.view3_Slider.value(),
                kernel=self.centWidget.kernel,
                file_type=self.file_type,
                atlas_name=self.atlas_name,
                rotation=self.centWidget.rotation_view3,
            )
        except:
            var = traceback.format_exc()
            user_answer = messageBox_popup(
    ...
    def restore_original_image(self):
        try:
            ...
            self.centWidget.slider_fun(
                self.centWidget.view1_Slider.value(), anat_plan="View_1"
            )
            self.centWidget.slider_fun(
                self.centWidget.view2_Slider.value(), anat_plan="View_2"
            )
            self.centWidget.slider_fun(
                self.centWidget.view3_Slider.value(), anat_plan="View_3"
            )
...
class MRI_widget(QWidget):
    ...
    def set_layout(self):
        ...
        self.global_frame.setSizePolicy(
        ...
        self.container_frame_1.setSizePolicy(
            QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Expanding
        )

        if developper_mode_1:
            self.container_frame_1.setObjectName("container_frame_1")
            self.container_frame_1.setStyleSheet(
                "QFrame#container_frame_1 {background: #666666; border: 2px solid #000000;}"
            )
        ...
        self.container_frame_1_1.setSizePolicy(
            QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Expanding
        )

        if developper_mode_1:
            self.container_frame_1_1.setObjectName("container_frame_1_1")
            self.container_frame_1_1.setStyleSheet(
                "QFrame#container_frame_1_1 {background: #adadad; border: 2px solid #000000;}"
            )
        ...
        self.container_frame_1_2.setSizePolicy(
            QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Expanding
        )

        if developper_mode_1:
            self.container_frame_1_2.setObjectName("container_frame_1_2")
            self.container_frame_1_2.setStyleSheet(
                "QFrame#container_frame_1_2 {background: #adadad; border: 2px solid #000000;}"
            )
        ...
        self.container_frame_1_1_1.setSizePolicy(
            QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Expanding
        )

        if True:
            self.container_frame_1_1_1.setObjectName("container_frame_1_1_1")
            self.container_frame_1_1_1.setStyleSheet(
                "QFrame#container_frame_1_1_1 {background: #ebebeb; border: 2px solid #000000;}"
            )
        ...
        self.container_frame_1_1_2.setSizePolicy(
            QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Expanding
        )

        if True:
            self.container_frame_1_1_2.setObjectName("container_frame_1_1_2")
            self.container_frame_1_1_2.setStyleSheet(
                "QFrame#container_frame_1_1_2 {background: #ebebeb; border: 2px solid #000000;}"
            )
        ...
        self.container_frame_1_1_3.setSizePolicy(
            QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Expanding
        )

        if True:
            self.container_frame_1_1_3.setObjectName("container_frame_1_1_3")
            self.container_frame_1_1_3.setStyleSheet(
                "QFrame#container_frame_1_1_3 {background: #ebebeb; border: 2px solid #000000;}"
            )
        ...
        self.container_frame_1_1_4.setSizePolicy(
            QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Expanding
        )

        if True:
            self.container_frame_1_1_4.setObjectName("container_frame_1_1_4")
            self.container_frame_1_1_4.setStyleSheet(
                "QFrame#container_frame_1_1_4 {background: #ebebeb; border: 2px solid #000000;}"
            )
        ...
        self.container_frame_1_1_1_1.setSizePolicy(
            QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Expanding
        )
        ...
        if True:
            ...
            self.container_frame_1_1_1_1.setStyleSheet(
                "QFrame#container_frame_1_1_1_1 {background: white; border: 2px solid #000000;}"
            )
        ...
        self.container_frame_1_1_1_2.setSizePolicy(
            QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Expanding
        )
        ...
        if True:
            ...
            self.container_frame_1_1_1_2.setStyleSheet(
                "QFrame#container_frame_1_1_1_2 {background: white; border: 2px solid #000000;}"
            )
        ...
        self.container_frame_1_1_1_3.setSizePolicy(
            QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Expanding
        )
        ...
        if True:
            ...
            self.container_frame_1_1_1_3.setStyleSheet(
                "QFrame#container_frame_1_1_1_3 {background: white; border: 2px solid #000000;}"
            )
        ...
        self.container_frame_1_1_1_4.setSizePolicy(
            QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Expanding
        )
        ...
        if True:
            ...
            self.container_frame_1_1_1_4.setStyleSheet(
                "QFrame#container_frame_1_1_1_4 {background: white; border: 2px solid #000000;}"
            )
    ...
    def fill_layout(self):
        ...
        self.view1_Slider.valueChanged.connect(
            lambda: self.slider_fun(self.view1_Slider.value(), anat_plan="View_1")
        )
        ...
        self.view2_Slider.valueChanged.connect(
            lambda: self.slider_fun(self.view2_Slider.value(), anat_plan="View_2")
        )
        ...
        self.view3_Slider.valueChanged.connect(
            lambda: self.slider_fun(self.view3_Slider.value(), anat_plan="View_3")
        )
    ...
    def slider_fun(self, slider_val, anat_plan):
        if "Expanded" in anat_plan:
            self.img_view4 = plot_volume(
                self.expanded_widget.figure_canvas,
                self.volume,
                anat_plan.split("-")[1],
                slider_val,
                kernel=self.kernel,
                file_type=self.file_type,
                atlas_name=self.atlas_name,
                rotation=self.expanded_rotation,
            )
        elif anat_plan == "View_1":
            self.img_view1 = plot_volume(
                self.figure1_canvas,
                self.volume,
                anat_plan,
                slider_val,
                ...
                file_type=self.file_type,
                atlas_name=self.atlas_name,
                rotation=self.rotation_view1,
            )
        elif anat_plan == "View_2":
            self.img_view2 = plot_volume(
                self.figure2_canvas,
                self.volume,
                anat_plan,
                slider_val,
                ...
                file_type=self.file_type,
                atlas_name=self.atlas_name,
                rotation=self.rotation_view2,
            )
        elif anat_plan == "View_3":
            self.img_view3 = plot_volume(
                self.figure3_canvas,
                self.volume,
                anat_plan,
                slider_val,
    ...
    def expandView_fun(self, spinbox_val):
        ...
        if anat_plan == "View_1":
            self.img_view_expanded = plot_volume(
                self.expanded_widget.figure_canvas,
                self.volume,
                anat_plan,
                self.view5_Slider.value(),
                kernel=self.kernel,
                file_type=self.file_type,
                atlas_name=self.atlas_name,
                rotation=self.rotation_view1,
            )
            self.view5_Slider.valueChanged.connect(
                lambda: self.slider_fun(
                    self.view5_Slider.value(), f"Expanded-{anat_plan}"
                )
            )
