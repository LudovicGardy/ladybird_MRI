...
from ladybird_MRI_app.load_volume import load_volume
from ladybird_MRI_app.plot_volume import plot_volume
from ladybird_MRI_app.zoomed_window import MplCanvas, ExpandedCanvas
from ladybird_MRI_app.widgets.custom_slider import custom_slider
from ladybird_MRI_app.messageBox_popup import messageBox_popup

from ladybird_MRI_app.config_file import get_path
path_dict = get_path()
...
class Main_Win(QMainWindow):
    def __init__(self):
        ...
        self.setWindowIcon(QtGui.QIcon(os.path.join(path_dict["root"], "ladybird_MRI_app", "static", "mri.ico")))
